!isEmpty(QSTUDIOSCADA_PRI_INCLUDED):error("QStudioSCADA.pri already included")
QSTUDIOSCADA_PRI_INCLUDED = 1

QSTUDIOSCADA_VERSION = 0.0.1
QSTUDIOSCADA_COMPAT_VERSION = 0.0.1
...
IDE_APP_PATH = $$IDE_BUILD_TREE/../QStudioSCADABin/bin
...
osx {
    ...
    win32: \
        ...
        IDE_LIBEXEC_PATH = $$IDE_OUTPUT_PATH/../QStudioSCADABin/libexec
    ...
    INSTALL_DEVICE_PLUGIN_PATH  = $$IDE_OUTPUT_PATH/../QStudioSCADABin/deviceplugins
    INSTALL_DRAWAPPLICATION_PLUGIN_PATH  = $$IDE_OUTPUT_PATH/../QStudioSCADABin/DrawApplicationPlugins
