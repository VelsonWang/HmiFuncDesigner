...
*插槽：单击确定
*/
void ScriptEditorDlg::on_btnOk_clicked()
{
    this->accept();
}
...
*插槽：单击取消
*/
void ScriptEditorDlg::on_btnCancel_clicked()
{
    this->reject();
}
...
void ScriptEditorDlg::on_btnToolSyntaxcheck_clicked()
{
    ...
    QScriptSyntaxCheckResult syntaxCheckResult = engine.checkSyntax (scriptContents);
