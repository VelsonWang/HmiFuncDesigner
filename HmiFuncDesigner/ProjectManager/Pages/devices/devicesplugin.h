...
#define PLUGIN_NAME "Plugin.Page.CommunicationDevice"

class DevicesPlugin : public QAbstractPage
{
    Q_OBJECT
    Q_INTERFACES(QPluginInterface)
    Q_PLUGIN_METADATA(IID QPluginInterface_iid FILE "devicesplugin.json")
public:
