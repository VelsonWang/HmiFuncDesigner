...
///
/// \brief ModbusASCII::devicePropertiesToString
/// \details 保存属性为字符串
/// \param properties 属性
/// \return 属性字符串
///
QString ModbusASCII::devicePropertiesToString(QVector<QPair<QString, QString>>& properties)
{
...
///
/// \brief ModbusASCII::devicePropertiesFromString
/// \details 从字符串加载属性
/// \param szProperty 属性字符串
/// \param properties 属性
///
void ModbusASCII::devicePropertiesFromString(const QString &szProperty, QVector<QPair<QString, QString>>& properties)
{
    properties.clear();
