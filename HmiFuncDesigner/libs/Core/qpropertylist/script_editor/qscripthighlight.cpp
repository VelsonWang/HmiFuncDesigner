...
QScriptHighLight::QScriptHighLight(QTextDocument *document)
...
QScriptHighLight::~QScriptHighLight()
{
}

void QScriptHighLight::highlightBlock(const QString &text)
{
...
void QScriptHighLight::highlightWord(int currentPos, const QString &buffer)
{
    if (buffer.isEmpty())
        return;
    if (isKeyword(buffer))
